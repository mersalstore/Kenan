...
var MediaController = function () {
    var _classDecorators = [(0, common_1.Controller)("api/media"), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, permissions_guard_1.PermissionsGuard)];
    ...
    var MediaController = _classThis = /** @class */ (function () {
        ...
        MediaController_1.prototype.uploadFile = function (projectId, file) {
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.mediaService.uploadFile(projectId, file)];
                        case 1:
                            url = _a.sent();
    ...
    (function () {
        ...
        _uploadFile_decorators = [(0, common_1.Post)("upload/:projectId"), (0, permissions_decorator_1.RequirePermission)("media", "CREATE"), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)("file"))];
