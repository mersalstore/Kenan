                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!token) {
                                throw new common_1.UnauthorizedException("التوكين المعتمد غير موجود أو غير صالح");
                            }
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                        ...
                        case 3:
                            _a = _b.sent();
                            throw new common_1.UnauthorizedException("التوكين منتهي الصلاحية أو غير صالح");
