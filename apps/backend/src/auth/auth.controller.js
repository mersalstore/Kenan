...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.getConfig = function () {
        ...
        AuthController_1.prototype.refresh = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.refresh(token)];
                });
            });
        };
        AuthController_1.prototype.logout = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.logout(token)];
                });
            });
        };
    ...
    (function () {
        ...
        _googleLogin_decorators = [(0, common_1.Post)("google"), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
