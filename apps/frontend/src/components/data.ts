...
export const seedSite: SiteSettings = {
  ...
  contractGeneralTerms: `مدة هذا المشروع سنة وتعتمد حسب سير العمل في الموقع، تبدأ اعتبارا من تاريخ توقيع العقد بين الطرفين واستلام الدفعة الأولى غير قابلة للتمديد.
...
يلتزم الطرف الأول بعدم إجراء أي تعديلات أو إضافة أو حذف إلا بعد موافقة خطية من الطرف الثاني أو من يمثله.
عرض السعر والعرض الفني جزء لا يتجزأ من هذا العقد.
...
يلتزم الطرف الثاني بسداد الدفعات خلال مدة لا تتجاوز 10 أيام عمل، وفي حالة تأخره في السداد يتم زيادة أيام التأخير في مدة العقد.`,
  contractFines: `في حال لم ينته المقاول من تنفيذ الأعمال المتعاقد عليها بعد انقضاء المدة المحددة للعقد، يتم احتساب غرامة تأخير على الطرف الأول بمقدار (300) ريال عن كل يوم تأخير، على ألا يتجاوز إجمالي هذه المبالغ 10% من قيمة العقد.
للطرف الثاني الحق في خصم تلك الغرامة من مستحقات المقاول بعد إخطار الطرف الأول بخطاب رسمي عن طريق الإيميل المدون بهذا العقد.`,
  contractSafety: `يلتزم الطرف الأول بتوفير وتأمين العدد الكافي من الأيدي العاملة اللازمة والمطلوبة لتنفيذ المشروع.
...
العرض لا يشمل الأعمال المدنية من تكسير وحفر وردم.`,
  companyNameAr: "مؤسسة كنان لأنظمة الأمن والسلامة",
  companyNameEn: "Kanan Safety & Fire Protection Systems Co.",
  companyCRNumber: "7050404537",
  companyTaxNumber: "313072607300003",
};
